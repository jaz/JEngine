...
public class FTPHL7Sender extends FTPClient implements Runnable {
	...
	private void goGetThem() {
		...
		try {
			...
			//get the queue and collect messages
			//create file for messages
			//connect FTP
			//send file
			//if successful, acknowledge msg Q
    ...
    public void run()
    {
    	while (true) {
    		try {
    			log.debug("connect and send file...");
    			goGetThem();
