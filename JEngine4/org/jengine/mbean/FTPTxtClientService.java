...
public class FTPTxtClientService extends ServiceMBeanSupport implements FTPTxtClientServiceMBean
{
	private FTPTxtClient client;
	private Category log;
	String protocol = "Clear";    // SSL/TLS
	
	public FTPTxtClientService()
	{
		log = Category.getInstance("FTPTxtClientService");
		try {
			client = new FTPTxtClient(protocol);
		} catch (java.security.NoSuchAlgorithmException e) {
			log.error("FTP client constructor ERROR: " + e.getMessage());
			e.printStackTrace();
		}
	}
	...
	public void setDelimiter(String dl) { client.setDelimiter(dl); }
	public String getDelimiter() { return client.getDelimiter(); }
	...
	public String getConverterProperties() { return client.getConverterProperties(); }
	public void setConverterProperties(String s) { client.setConverterProperties(s); }

	public String getProtocol() { return client.getProtocol(); }
	public void setProtocol(String p) { client.setProtocol(p); }
