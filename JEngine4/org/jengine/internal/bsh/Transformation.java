...
public class Transformation implements org.jengine.mbean.Transformation {
  ...
  public class Utils {
	  public String addZeroPad(String s, int length) {
		  String formatting = "%0" + length + "d";
		  return String.format(formatting, Integer.parseInt(s));
	  }
  }
  ...
  public String transform(String message) {
    ...
    try {
      ...
      interpreter.eval("org.jengine.internal.bsh.Transformation.Utils util");
      interpreter.set("util", new Utils());
